...
> The domain and application foundation shared by the Atlas ecosystem.
...
Atlas Core concentrates the concepts that must remain stable while interfaces, databases, providers, and experiments evolve. It is the place for business language, explicit use cases, shared contracts, and small architectural primitives—not a dumping ground for generic helpers.
...
- Configuration boundaries and typed errors
- Plugin contracts and extension points
- Cross-module identifiers and lifecycle rules

## Reference deliverables

- A minimal data-source domain model
- Registration and catalog use cases
- Ports for persistence and event publication
- Architecture tests for dependency direction
- Examples that show the domain without infrastructure
...
- Atlas API invokes its use cases
- Data Engineering implements persistence ports
- Automation and AI consume stable contracts
